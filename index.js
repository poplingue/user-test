 ...
 * @Last Modified time: 2016-07-31 15:41:33
 */
...
var app = {
  ...
  expressionsCapture: function(faces) {
    ...
    var i = 0,
      self = this,
      expressionFrench = ['rire', 'innerBrowRaise', 'hauteur des sourcils', 'froncement sourcils', 'ride du nez', 'lèvre supérieur surélevée', 'coin de la bouche vers bas', 'hauteur menton', 'lèvres vers l\'avant', 'lèvres pincées', 'lèvres rentrées', 'bouche ouverte', 'petit sourire satisfait', 'fermeture des yeux', 'attention', 'visage serré', 'mâchoire abaissée', 'coin de la bouche serrés', 'ouverture yeux', 'sourire', 'lèvres serrées'];
    ...
    if (faces[0]) {
      ...
      for (var prop in faces[0].expressions) {
        ...
        //list expressions
        if (!this.listExp) {
          this.chart[i].legendText = expressionFrench[i];
        }
